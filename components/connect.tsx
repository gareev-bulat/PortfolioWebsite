  ...
  return (
    ...
    <form className='max-w-3xl mx-auto mt-8 mb-20 space-y-4 text-white text-base_l shadow-2xl shadow-white bg-gradient-to-b flex flex-col items-center p-4 rounded-3xl from-[#964734] to-[#0FA4AF]'>
      <div className='flex flex-col w-full px-4'>
        ...
        <input className='h-10 bg-white border border-gray-300 focus:outline-none transition ease-in-out rounded-[5px] text-black text-base font-extralight p-4 required'></input>
      ...
      <div className='flex flex-col w-full px-4'>
        ...
        <input className='h-10 bg-white border border-gray-300 focus:outline-none transition ease-in-out rounded-[5px] text-black text-base font-extralight p-4'></input>
      </div>
      ...
      <button type="submit" className='h-full px-10 py-2 mt-4 text-md bg-[#964734] hover:bg-[#E64833] shadow-2xl shadow-white rounded-3xl'>Send</button>
    <div>
