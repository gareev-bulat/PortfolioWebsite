          ...
          <div className="flex flex-col items-center">
            ...
            >
              <Image
                ...
                height={40}
              />
              <h3 className="text-1xl sm:text-1xl md:text-1xl lg:text-2xl p-2 text-white">
                Download my CV
              </h3>
            </a>
          </div>
          ...
          <div className="flex flex-col text-white">
            ...
            <div className="flex flex-row">
              <Link
                ...
                className="inline-block bg-white hover:bg-brand-1000 rounded-md m-4 transition-colors duration-200 ease-in-out"
              >
                <h3 className="text-black hover:text-white py-2 px-4">Gmail</h3>
              </Link>
              <Link
                href="https://github.com/gareev-bulat"
                className="inline-block bg-white hover:bg-brand-0 rounded-md m-4 transition-colors duration-200 ease-in-out"
              >
              ...
              <Link
                ...
                className="inline-block bg-white hover:bg-brand-300 rounded-md m-4 transition-colors duration-200 ease-in-out"
              >
                <h3 className="text-black hover:text-white py-2 px-4">
                  LinkeldIn
                </h3>
